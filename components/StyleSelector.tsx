...
const StyleSelector: React.FC<StyleSelectorProps> = ({ selectedStyle, onSelect, disabled, t, stylesTranslation, mode = 'grid' }) => {
  ...
  const renderTooltip = (style: StyleOption, styleInfo: any) => {
    if (hoveredStyle !== style.id) return null;
    return (
            ...
            return (
              ...
              >
                <button
                  ...
                  `}
                >
                  <div className={`w-10 h-10 rounded-md ${style.previewColor} shrink-0 relative overflow-hidden shadow-sm group-hover:scale-105 transition-transform flex items-center justify-center`}>
