...
export const TRANSLATIONS = {
  'zh-TW': {
    ...
    api_key_desc: "請輸入您的 Gemini API Key 以繼續使用。您的金鑰只會儲存在本地瀏覽器中，不會傳送到我們的伺服器。",
    api_key_placeholder: "輸入您的 Gemini API Key...",
    api_key_link: "按此取得 Gemini API Key",
    api_key_save: "儲存 API Key",
  ...
  'en': {
    ...
    api_key_desc: "Please enter your Gemini API Key to continue. Your key is stored locally in your browser and is never sent to our servers.",
    api_key_placeholder: "Enter Gemini API Key...",
    api_key_link: "Get your Gemini API Key here",
  ...
  'ja': {
    ...
    api_key_title: "API Key が必要です",
    api_key_desc: "続行するにはGemini API Keyを入力してください。キーはローカルのブラウザにのみ保存され、サーバーには送信されません。",
    api_key_placeholder: "Gemini API Key を入力...",
    api_key_link: "こちらから Gemini API Key を取得",
    api_key_save: "API Key を保存",
    footer: "© 2026 Sticker Maker Pro. Powered by Google Gemini. All rights reserved.",
