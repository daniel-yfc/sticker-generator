...
export const TRANSLATIONS: Record<Language, TranslationContent> = {
  'zh-TW': {
    ...
    sticker_tile_failed: "此貼圖生成失敗",
    btn_retry_variation: "重試此張",
    sticker_partial_success: "部分貼圖已完成，失敗的可單獨重試。",
    sticker_generating_variation: "生成中…",
  ...
  'en': {
    ...
    sticker_tile_failed: "This sticker failed to generate",
    btn_retry_variation: "Retry this one",
    sticker_partial_success: "Some stickers are ready. Failed ones can be retried individually.",
    sticker_generating_variation: "Generating…",
  ...
  'ja': {
    ...
    sticker_tile_failed: "このステッカーの生成に失敗しました",
    btn_retry_variation: "これだけ再試行",
    sticker_partial_success: "一部のステッカーが完成しました。失敗したものは個別に再試行できます。",
    sticker_generating_variation: "生成中…",
